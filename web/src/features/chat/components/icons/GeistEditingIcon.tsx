...
interface GeistEditingIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
}

export function GeistEditingIcon({ className, size = 28, ...props }: GeistEditingIconProps) {
  return (
    <svg
      className={cn("geist-editing-icon", className)}
